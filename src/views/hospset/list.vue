<template>
  <div class="app-container">
    ...
    <!-- 工具条 -->
    <div>
      <el-button type="danger" size="mini" @click="removeRows()">批量删除
      </el-button>
    </div>
    ...
    <el-table :data="list" stripe style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="apiUrl" label="api 基础路径" width="200" />
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
          ...
          <router-link :to="'/edit/' + scope.row.id"><el-button type="primary" size="mini"
              icon="el-icon-edit"></el-button></router-link>
  ...
  methods: {//定义方法，进行请求接口调用
    ...
    getList(page = 1) { //添加当前页参数
      ...
      hospset.getHospSetList(this.current, this.limit, this.searchObj)
        .then(response => { //请求成功 response 是接口返回数据
